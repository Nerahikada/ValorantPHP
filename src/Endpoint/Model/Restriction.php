...
class Restriction
{
    private string $type;   // TIME_BAN, PERMANENT_BAN, TEXT_CHAT_MUTEDBAN, ...
    private string $reason; // GAMEPLAY_VIOLATION, AC_SCRIPTING_PERMANENT, INAPPROPRIATE_RIOT_ID, INAPPROPRIATE_TEXT, ...
